...
const street = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
  ...
  maxZoom: 22 // adding the max zoom layer for the base map
      ...
      const myMap = L.map("map", {
        center: [34.259432, -117.157154], //adding in default location the map opens to here
      ...
      fetch('https://docs.google.com/spreadsheets/d/1mK5HTfctSwaLs2soh9EaH3bSEF4EZ8qv/gviz/tq?') 
        .then(res => res.text())
        .then(text => {
