...
const street = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
  ...
  maxZoom: 22 // adding the max zoom layer for the base map
      ...
      const myMap = L.map("map", {
        center: [32.694836, -117.138274], //adding in default location the map opens to here
      ...
      fetch('https://docs.google.com/spreadsheets/d/1-B801_52z64Kg0-6viaDG6uV66pZdDCq/gviz/tq?') 
        .then(res => res.text())
        .then(text => {
          const clean = text
