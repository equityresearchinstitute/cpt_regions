...
const street = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
  ...
  maxZoom: 22 // adding the max zoom layer for the base map
      ...
      const myMap = L.map("map", {
        center: [35.366356, -118.949093], //adding in default location the map opens to here
      ...
      fetch('https://docs.google.com/spreadsheets/d/10OmtBnNvRn_90Zdhh88hFYBdK4CjbF91/gviz/tq?') 
        .then(res => res.json())
        .then(response => {
          if (!response.success) {
